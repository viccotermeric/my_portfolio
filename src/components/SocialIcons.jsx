...
export function SocialIcons({ darkMode, onToggleTheme, onToggleView, terminalMode, highlightToggle, onEmailClick }) {
  return (
    <div id="contact-icons">
      ...
      <a href="#" title="Email" onClick={(e) => { e.preventDefault(); onEmailClick(); }}>
